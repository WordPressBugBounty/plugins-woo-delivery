...
✅ **HPOS Compatibility:** The plugin is now fully compatible with High performance order storage(HPOS).
...
✅ **Hide plugin module based on Category/Product/Specific User Role:** Admin can completely hide the plugin for a specific category/product/specific User role.
...
✅ **Filtering and Bulk Action Functionality on WooCommerce Order page:** After installing the PRO version of WooCommerce order delivery date time plugin, admin can filter orders according to the delivery/pickup date on the WooCommerce order page.
...
1. Upload `woo-delivery.zip` to the `/wp-content/plugins/` directory
...
7. Pickup Time Settings

8. Localization Settings

9. Other Settings

10. Order Page Metabox

11. Checkout Page Delivery Date Field View

12. Checkout Page Delivery Time Field View

13. Checkout Page Pickup Date Field View
...
* Tweak: Compatibility check with WordPress v7.0
...
= 1.3.81 =
* Tweak: Compatibility check with WC v10.6.2

= 1.3.80 =
* Fixed: Alternative shipping methods are hidden if using only delivery or pickup for classic checkout.
...
= 1.3.66 =
* Fixed: Validation is not working for some payment plugin.

= 1.3.65 =
* Fixed: Compatibility issue with Divi builder made checkout page is fixed.

= 1.3.64 =
* Tweak: Unnecessary files are deleted.
...
= 1.3.58 =
* Tweak: Change the default meta box heading in single order page.
